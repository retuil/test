...
def send_message(service, user_id, message):
    ...
    """
    try:
        message = (service.users().messages().send(userId=user_id, body=message, token=)
                   .execute())
...
text = create_message('cheking-system@checksyst.iam.gserviceaccount.com', 'surganov.denis@gmail.com', 'test',
                      'test test test')
